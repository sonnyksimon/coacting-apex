create or replace procedure blob2attachment (p_table varchar2, p_blob varchar2, p_name varchar2, p_mimetype varchar2, p_key varchar2, p_id varchar2)
is
v_blob blob;
v_name varchar2(64);
...
begin
    ...
    if v_length > 0 then
        ...
        sys.htp.p('Content-Disposition: attachment; filename="'||apex_escape.html(v_name)||'"; filename*=UTF-8'''''||apex_escape.html(v_name));
