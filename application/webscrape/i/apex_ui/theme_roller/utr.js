(function($, lang, storage, debug){
    ...
    var self = window.apex.utr,
        ...
        STR = {
            ...
            PALETTE_GENERATOR_DUAL: msg( "UTR.PALETTE_GENERATOR.DUAL" ),
            ...
            TOOLBAR_BUTTONS_PALETTE_GENERATOR: msg( "UTR.TOOLBAR.BUTTONS.PALETTE_GENERATOR" ),
            PALETTE_GENERATOR_BASE_RGB: msg( "UTR.PALETTE_GENERATOR.BASE_RGB" ),
            PALETTE_GENERATOR_SEPARATION: msg( "UTR.PALETTE_GENERATOR.SEPARATION" ),
            PALETTE_GENERATOR_MONOCHROMATIC: msg( "UTR.PALETTE_GENERATOR.MONOCHROMATIC" ),
            PALETTE_GENERATOR_TRIAD: msg( "UTR.PALETTE_GENERATOR.TRIAD" ),
            PALETTE_GENERATOR_TETRAD: msg( "UTR.PALETTE_GENERATOR.TETRAD" ),
            PALETTE_GENERATOR_WITH_COMPLEMENT: msg( "UTR.PALETTE_GENERATOR.WITH_COMPLEMENT" ),
            SEARCH: msg( "UTR.SEARCH" ),
            UNDO: msg( "UTR.UNDO" ),
            REDO: msg( "UTR.REDO" ),
            CONFIG_OUTPUT: msg( "UTR.CONFIG_OUTPUT" ),
            CONFIG_OUTPUT_ERROR: msg( "UTR.CONFIG_OUTPUT_ERRO" )
        };
                    ...
                    if ((typeof searchText === 'undefined' || searchText === '')) {
                        ...
                        if ( less.palette.enabled ) {
                            ...
                            var currentMode,
                                ...
                                i;
                            for( i = 0; i < less.palette.availableModes.length; i++ ){
