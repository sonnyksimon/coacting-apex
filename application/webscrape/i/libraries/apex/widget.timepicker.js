...
/*
 Copyright (c) 2012, 20167, Oracle and/or its affiliates. All rights reserved.
 */
/*global apex*/
                ...
                if (this._colonPos != -1) {
                  ...
                  //a = (ampmPos != -1) ? $.trim(dt.substr(ampmPos,ampmlength)) : '';
                    ...
                    if (sPos == -1 ) {
                        ...
                        a = $.trim(dt.substr(this._colonPos + 3, ampmlength));
                    }
                    else {
                        ...
                        a = $.trim(dt.substr(this._colonPos + 7, ampmlength));
                  }
